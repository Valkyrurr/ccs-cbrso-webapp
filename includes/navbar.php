...
<div id="accordion" class="col-md-2 sidebar">
	...
	<ul class="nav nav-sidebar">
		...
		<li><a href="#search" data-toggle="collapse"><span
			...
			<div id="search" class="collapse">
				<form class="form-inline"
					action="/ccs-cbrso-webapp/search/search.php" method="get">
					<div class="form-group">
						...
						<div class="col-md-12">
							<div class="radio">
								<label><input type="radio" name="category" value="1" required>
									Thematic Area</label> <label><input type="radio"
									name="category" value="2" required> CCS Area</label> <label><input
									type="radio" name="category" value="3" required> Thesis Title</label>
								<label><input type="radio" name="category" value="4" required>
									Adviser Name</label> <label><input type="radio" name="category"
		...
		<?php else: ?>
		<li><a href='/ccs-cbrso-webapp/user/index.php'><span
